...
|    3 | Overview: Python programming        |
|    4 | Getting to know =turtle=              |
|    5 | Getting started with =turtle=         |
|    6 | Programming with =turtle= I           |
|    7 | Programming with =turtle II=          |
|    8 | Using Loops: =for= loops              |
|    9 | Using Loops: =while= loops            |
|   10 | Using conditional statements        |
|   11 | Using conditional statements        |
|   12 | Final project: setting up           |
|   13 | Final project: creating the die     |
|   14 | Final project: game development     |
