...
- Here is an [[https://github.com/birkenkrahe/cor/blob/main/org/ai_paper.org][example paper]] written by AI as "Young Meno", who attended
  my "Game Programming with Python" course (approximately 2 pages)
